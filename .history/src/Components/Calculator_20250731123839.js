...
function Calculator() {
    ...
    const Number = (e) => {
        ...
        if(forNextNum.current === true){
             setMonitorValue(value);
                forNextNum.current = false; // ✅ reset flag after new input starts
                return;
        }
    ...
    const HandleOperator = (e) => {
        e.preventDefault();
        setFirstNumber(monitorValue);
        setOperator(e.target.value);
       
        forNextNum.current  = true;
        console.log(forNextNum.current);
    ...
    const Equals = (e) => {
        ...
        const num2 = parseFloat(monitorValue);

        switch (operator){
            case '+':
                return setMonitorValue((num1 + num2).toString());
            case '-':
                 return setMonitorValue((num1 - num2).toString());
            case '*':
                 return setMonitorValue((num1 * num2).toString());
            case '/':
                return num2 !==0 ? setMonitorValue((num1 / num2).toString()) : 'Error';
        }
    }
        ...
        <form className='form'>
            ...
            <div className='btns-column'>
                ...
                <div className='right-container'>
                            ...
                            <button className='rigth-btn-extends'  onClick={Equals}>=</button>
                </div>
