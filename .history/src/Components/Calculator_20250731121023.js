...
function Calculator() {
    ...
    const [waitingforsecond , setWatingforsecond] = useState(false);
            ...
            <div className='btns-column'>
                <div className='left-container'>
                    <div className='first-layer'>
                            ...
                            <button value={'divide'} onClick={HandleOperator} >/</button>
                            <button value={'multipl'} onClick={HandleOperator}>*</button>
                    </div>
